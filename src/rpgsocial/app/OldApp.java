...
public class OldApp {
    ...
    private Map<String, OldUser> users = new HashMap<>();
    
    private OldUser userLogged = null;
     ...
     */
    public boolean registerUser(OldUser user) {
     ...
     */
    public Collection<OldUser> getAllUsers() {
        return users.values();
    }
    ...
    private void loadUsers() {
        ...
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(file))) {
            users = (Map<String, OldUser>) ois.readObject();
