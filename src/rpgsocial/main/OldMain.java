...
import java.util.*;
import rpgsocial.app.OldApp;
import rpgsocial.model.OldConcept;
import rpgsocial.model.OldUser;
        ...
        do {
            ...
            switch (option) {
                case 1 -> {
                    ...
                    OldUser newUser = new OldUser(username, email, password, age, city, country);
                ...
                case 4 -> {
                    ...
                    for (OldUser u : app.getAllUsers()) {
                        System.out.println(u);
                    }
                }
                case 5 -> {
                    OldUser user = app.getLoggedUser();
                ...
                case 6 -> {
                    ...
                    OldConcept newConcept = new OldConcept(name, system, schedule, description, tags);
